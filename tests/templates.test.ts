...
describe('Template System', () => {
  ...
  describe('Template Inheritance', () => {
    test('extends base template correctly', () => {
      ...
      const result = await child({}, faker, {});
  ...
  describe('Conditional Logic', () => {
    test('if statements work correctly', () => {
      ...
      const shown = await template({ data: { show: true } }, {}, {});
      expect(shown).toContain('Shown');
      expect(shown).not.toContain('Hidden');

      const hidden = await template({ data: { show: false } }, {}, {});
  ...
  describe('Loops', () => {
    test('for loops work correctly', () => {
      ...
      const result = await template({ data: { items: ['one', 'two', 'three'] } }, {}, {});
  ...
  test('safe filter working in template', () => {
    ...
    const noSafeResult = await noSafeTemplate(page, {}, {});
    ...
    const safeResult = await safeAppliedTemplate(page, {}, {});
